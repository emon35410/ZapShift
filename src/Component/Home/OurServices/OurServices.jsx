...
const OurServices = () => {
    ...
    return (
        <div data-aos="flip-left" className='bg-accent shadow-sm rounded-2xl my-8 mx-1   py-5 '>
            <div>
                ...
                <div data-aos="slide-up"  className='grid grid-cols-1 md:grid-cols-3 gap-5 mx-5 md:mx-25 my-10 '>
                    {
